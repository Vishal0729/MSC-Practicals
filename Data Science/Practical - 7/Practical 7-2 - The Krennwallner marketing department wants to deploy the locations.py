...
print('################################')
sFileName=Base+'Inputs/02-Krennwallner/Retrieve_DE_Billboard_Locations.csv'
...
sFileNameHtml=Base+'Inputs/02-Krennwallner/Billboard1.html'
...
sFileNameHtml=Base+'Inputs/02-Krennwallner/Billboard2.html'
...
sFileNameHtml=Base+'Inputs/02-Krennwallner/Billboard_heatmap.html'
